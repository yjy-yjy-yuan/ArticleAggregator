# [ArticleAggregator.dev](https://bestblogs.dev)

遇见更好的技术阅读，汇集顶级软件编程、人工智能、产品设计、商业科技、自我成长类文章，使用大语言模型进行评分、摘要、翻译等，让阅读更轻松、学习更高效。

## 1. 介绍

ArticleAggregator.dev 为您提供编程、人工智能、产品设计、商业科技和个人成长领域的精选内容，汇集自顶级技术公司和社区。我们利用先进的大语言模型，为每篇文章提供智能摘要、评分和翻译服务，帮助您快速筛选高价值内容，节省阅读时间。立即订阅，探索未来技术的无限可能！
...
**所有订阅源：** [ArticleAggregator_RSS_ALL.opml](./ArticleAggregator_RSS_ALL.opml)

- **文章类**（170 个订阅源）：[ArticleAggregator_RSS_Articles.opml](./ArticleAggregator_RSS_Articles.opml)
- **播客类**（30 个订阅源）：[ArticleAggregator_RSS_Podcasts.opml](./ArticleAggregator_RSS_Podcasts.opml)  
- **视频类**（40 个订阅源）：[ArticleAggregator_RSS_Videos.opml](./ArticleAggregator_RSS_Videos.opml)
- **Twitter 类**（160 个订阅源）：[ArticleAggregator_RSS_Twitters.opml](./ArticleAggregator_RSS_Twitters.opml)
...
ArticleAggregator.dev 提供灵活的 RSS 订阅功能，支持按需订阅：
...
更多参数说明和用法请参考：[ArticleAggregator.dev RSS 订阅指南](./ArticleAggregator_RSS_Doc.md)
...
ArticleAggregator.dev 提供开放 API 接口，支持文章、播客、推文等内容的智能分析和获取。

API 文档：[ArticleAggregator_OpenAPI_Doc.md](./ArticleAggregator_OpenAPI_Doc.md)

## 6. 实现原理

### 6.1 文章智能分析

详细实践文档：[ArticleAggregator.dev 基于 Dify Workflow 的文章智能分析实践](./flows/Dify/ArticleAggregator.dev%20基于%20Dify%20Workflow%20的文章智能分析实践.md)
...
**2. 文章初评流程**  
通过语言类型、内容质量等特征对文章进行初步评分，过滤低质量内容，提高后续处理效率。使用 Dify Workflow 实现，DSL 参见：[ArticleAggregator 文章初评流程](./flows/Dify/dsl/ArticleAggregator%20文章初评流程.yml)

**3. 文章深度分析流程**  
通过大语言模型（GPT-4o）对文章进行全面分析，生成一句话总结、详细摘要、主要观点、文章金句、领域分类、标签列表和质量评分等。包含 *分段分析 → 汇总分析 → 领域划分和标签生成 → 文章评分 → 检查反思 → 优化改进* 等环节。DSL 参见：[ArticleAggregator 文章分析流程](./flows/Dify/dsl/ArticleAggregator%20文章分析流程.yml)

**4. 多语言翻译流程**  
支持中英双语，自动识别原文语言并生成目标语言的分析结果。包含 *识别专业术语 → 初次翻译 → 检查翻译 → 意译优化* 等环节。DSL 参见：[ArticleAggregator 文章分析结果翻译流程](./flows/Dify/dsl/ArticleAggregator%20文章分析结果翻译.yml)

### 6.2 播客智能分析

实现方案详见：[ArticleAggregator.dev 基于通义听悟和 Dify 实现播客智能分析](./docs/ArticleAggregator.dev%20基于通义听悟和%20Dify%20实现播客智能分析.md)
...
实现方案详见：[ArticleAggregator.dev 基于 XGo.ing 和 Dify 实现推文智能分析](./docs/ArticleAggregator.dev%20基于%20XGo.ing%20和%20Dify%20实现推文智能分析.md)

## 7. 支持与交流

如果您觉得 ArticleAggregator.dev 对您有帮助，欢迎：
